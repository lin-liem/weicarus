...
<head>
	...
	<#-- 瀑布流 -->
    <link rel="stylesheet" href="${static!}/source/lib/hydrogen/css/animate.css">
...
<body class="is-3-column">
    ...
    <section class="section">
        <div class="container">
            <div class="columns">
				<div style="padding:0" class="column is-12-tablet is-12-desktop is-12-widescreen has-order-2 column-main">
				 <#nested />	
              </div>
            </div>
        </div>
    ...
    <script src="${static!}/source/lib/hydrogen/js/modernizr-2.6.2.min.js"></script>
    <script src="${static!}/source/lib/hydrogen/js/jquery.easing.1.3.js"></script>
    <script src="https://www.jq22.com/jquery/bootstrap-3.3.4.js"></script>
    <script src="${static!}/source/lib/hydrogen/js/jquery.waypoints.min.js"></script>
    <script src="${static!}/source/lib/hydrogen/js/jquery.magnific-popup.min.js"></script>
    <script src="${static!}/source/lib/hydrogen/js/salvattore.min.js"></script>
    <script src="${static!}/source/lib/hydrogen/js/main.js"></script>
</body>
</html>
</#macro>