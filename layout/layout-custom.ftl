...
<body class="is-3-column">
    ...
    <script src="${theme_base!}/source/lib/hydrogen/js/modernizr-2.6.2.min.js"></script>
    <script src="${theme_base!}/source/lib/hydrogen/js/jquery.easing.1.3.js"></script>
    <script src="https://www.jq22.com/jquery/bootstrap-3.3.4.js"></script>
    <script src="${theme_base!}/source/lib/hydrogen/js/jquery.waypoints.min.js"></script>
    <script src="${theme_base!}/source/lib/hydrogen/js/jquery.magnific-popup.min.js"></script>
    <script src="${theme_base!}/source/lib/hydrogen/js/salvattore.min.js"></script>
    <script src="${theme_base!}/source/lib/hydrogen/js/main.js"></script>
</body>
</html>
</#macro>